...
class DeliveryModeChangeNotApplicable extends Component {
                ...
                <ModalBody >
                    ...
                    <div className="row">
                        <div className="col-xs-12">
                            <p>¿Estas seguro de cambiar el modo de regalo de este articulo? Esta acción no afectará a los certificados de regalo ni experiencias</p>
                        </div>
                        <div className="col-xs-12">
...
export default DeliveryModeChangeNotApplicable;
