...
export default class DepositForm extends Component {
  ...
  onNextStepClick = () => {
    ...
    if(this.props.type === 'partial') this.props.nextPage(2);    
  }
      ...
      <div className="panel checkout-step non-printable">
        {
          ...
          <div>	
          <span className="checkout-step-number active">1</span>	
          <h4 className="titleModule">{commonUtil.getLabel(this.props.labels, 'eventTransferences.label1')}</h4>	
        </div>
         : null
        }
