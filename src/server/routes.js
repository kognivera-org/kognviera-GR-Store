const _ = require('lodash'),
    ...
    Routes = _.unionBy(accountSummary,activityLogs,cachecontrols,changeOfEvent,contract,delivery,
        eventCreation,eventdetails,addAddress,closingGiftPriceRange,editAddress,editEventInfo,employeeCardInfo,eventAddress,eventGralInfo,getState,labels,user,reports,returns,verificationDoc,printapi,
