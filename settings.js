...
module.exports = {
  development: {
    ...
    endpoints: {
      ...
      cache: `${(typeof os !== 'undefined' && typeof os.hostname !== 'undefined' ? os.hostname() : 'localhost')}:9089` , 
    },
  ...
  sit: {
    ...
    endpoints: {
      ...
      cache: `${(typeof os !== 'undefined' && typeof os.hostname !== 'undefined' ? os.hostname() : 'localhost')}:9099`,
      shoapp: 'https://shopappst.liverpool.com.mx',
      otpapp: 'https://gradapterpwaqa2.liverpool.com.mx',
    },
    redirectauth: 'https://odtaqaa.liverpool.com.mx/tienda',
